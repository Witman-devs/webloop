...
export default function Symbols({setPageName}) {
  return (
    <Stack style={{width:"50%", paddingLeft:"25%"}} padding={5}>
      ...
      <SymbolInfo image={<AntagonistLogo />}>
        ...
        the cycle of life and death, and the unity of all things.
        
        Also a symbol recently used by a <Link component="span" sx={{display:"inline"}} onClick={()=>setPageName("home")}> serial killer.</Link> 
